...
- Настройки позволяют собирать стили прописанные в `app.js`. Внимание данные стили будут распространяться и на другие портлеты. Чтобы это избежать можно добавлять стили в файл `\src\main\webapp\css\main.scss`.
---
###### Ссылки:
